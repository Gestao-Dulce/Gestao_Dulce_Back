...
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-DsAWY7-c.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "border-b border-sidebar-border md:border-border px-4 md:px-10 py-3 md:py-4 flex items-center justify-between bg-sidebar md:bg-card text-sidebar-foreground md:text-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex md:hidden items-center justify-between w-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoLucelian, alt: "Doces Lucelian", className: "h-8 w-auto object-contain brightness-0 invert" })
          ] })
        ] })
      ] }),
...
const appCss = "/assets/styles-B0Ve1Sfg.css";
...
const $$splitComponentImporter$6 = () => import("./vendas-Hh0IVjPo.mjs");
...
const $$splitComponentImporter$5 = () => import("./usuarios-C1zoV5GV.mjs");
...
const $$splitComponentImporter$4 = () => import("./produtos-C9pCO_gS.mjs");
const Route$4 = createFileRoute("/produtos")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./login-B5u6Ox96.mjs");
...
const $$splitComponentImporter$2 = () => import("./contas-a-pagar-B_Q4wxTM.mjs");
const Route$2 = createFileRoute("/contas-a-pagar")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./clientes-C_3iLZcf.mjs");
...
const $$splitComponentImporter = () => import("./index-ofuRulXE.mjs");
