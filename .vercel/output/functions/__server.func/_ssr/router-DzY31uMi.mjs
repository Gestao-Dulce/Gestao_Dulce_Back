...
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-PW7rofn3.mjs";
import { L as LogOut, S as Sun, M as Moon, a as Menu, b as LayoutDashboard, U as Users, P as Package, c as ShoppingBag, C as CalendarClock, d as UserPlus, X } from "../_libs/lucide-react.mjs";
...
function AppShell() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col md:flex-row bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "border-b border-border px-4 md:px-10 py-3 md:py-4 flex items-center justify-between bg-card", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex md:hidden items-center justify-between w-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: mobileMenuOpen, onOpenChange: setMobileMenuOpen, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "icon", className: "text-muted-foreground hover:text-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: toggle, "aria-label": "Alternar tema", className: "size-8", children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "size-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "size-4" }) }),
...
const appCss = "/assets/styles-DkXTD5eP.css";
...
const $$splitComponentImporter$6 = () => import("./vendas-Dv3HCsn2.mjs");
...
const $$splitComponentImporter$5 = () => import("./usuarios--WUp1Vl7.mjs");
...
const $$splitComponentImporter$4 = () => import("./produtos-CjjX2PSs.mjs");
const Route$4 = createFileRoute("/produtos")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./login-D4jTgjHC.mjs");
...
const $$splitComponentImporter$2 = () => import("./contas-a-pagar-CMO6-iFj.mjs");
const Route$2 = createFileRoute("/contas-a-pagar")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./clientes-C9jVOO7q.mjs");
...
const $$splitComponentImporter = () => import("./index-Cb45k3QJ.mjs");
