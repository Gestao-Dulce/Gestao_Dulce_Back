...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BfK7i7he.mjs");
...
const manifest = {
  "17d1a3f1318589df35d6836ee7087fc14f590a29332fd46b2e742bda662d97cc": {
    ...
    importer: () => import("./login-DbK9YcJC.mjs")
  },
  ...
  "53d1ca62673e273a8ca13066698e6b74ef727371d3f30b52aadc77f749552fb3": {
    ...
    importer: () => import("./usuarios-DGKK2tJD.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CFecRaRQ.mjs").then((n) => n.m),
    import("./start-vUb_mGok.mjs"),
