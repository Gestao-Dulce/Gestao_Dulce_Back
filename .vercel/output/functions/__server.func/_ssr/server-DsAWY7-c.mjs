...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BdCwG7WW.mjs");
...
const manifest = {
  "17d1a3f1318589df35d6836ee7087fc14f590a29332fd46b2e742bda662d97cc": {
    ...
    importer: () => import("./login-D_kVoGu_.mjs")
  },
  ...
  "53d1ca62673e273a8ca13066698e6b74ef727371d3f30b52aadc77f749552fb3": {
    ...
    importer: () => import("./usuarios-iE-pH5UL.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DQIUr6qS.mjs").then((n) => n.h),
    import("./start-DnAcQGMh.mjs"),
