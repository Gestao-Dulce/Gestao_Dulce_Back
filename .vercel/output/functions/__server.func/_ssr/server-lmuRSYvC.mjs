...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CWTvqZ6M.mjs");
...
const manifest = {
  "17d1a3f1318589df35d6836ee7087fc14f590a29332fd46b2e742bda662d97cc": {
    ...
    importer: () => import("./login-Bh0uwVhc.mjs")
  },
  ...
  "53d1ca62673e273a8ca13066698e6b74ef727371d3f30b52aadc77f749552fb3": {
    ...
    importer: () => import("./usuarios-CLmShdtO.mjs")
  },
  ...
  "e345c27d5ab3a542b5dde18807afcb51d5b46f62dbc9d2e5f5819f23467ad139": {
    ...
    importer: () => import("./AiAssistant-3zAgjm3b.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DCeOGSYb.mjs").then((n) => n.m),
    import("./start-C4YB13ZV.mjs"),
