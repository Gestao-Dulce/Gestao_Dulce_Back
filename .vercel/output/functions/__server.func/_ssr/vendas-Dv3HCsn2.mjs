...
import { B as Button } from "./router-DzY31uMi.mjs";
import { I as Input, L as Label } from "./label-BLFGti8y.mjs";
import { C as Card, a as CardHeader, b as CardContent, c as CardTitle } from "./card-q5sjhEZG.mjs";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, e as brl, f as dataBR, h as hoje } from "./select-C3H898CA.mjs";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell, A as AlertDialog, f as AlertDialogTrigger, g as AlertDialogContent, h as AlertDialogHeader, i as AlertDialogTitle, j as AlertDialogDescription, k as AlertDialogFooter, l as AlertDialogCancel, m as AlertDialogAction } from "./alert-dialog-BniYujbP.mjs";
import { B as Badge } from "./badge-CrM6Atmu.mjs";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle } from "./dialog-GLSItac_.mjs";
import { C as CurrencyInput } from "./currency-input-s86QF2C6.mjs";
import { t as toast } from "../_libs/sonner.mjs";
import { T as Textarea } from "./textarea-X_Vu-syt.mjs";
import "../_libs/seroval.mjs";
import { e as Printer, f as Plus, g as CircleCheckBig, h as Pencil, T as Trash2, d as UserPlus, i as PackagePlus } from "../_libs/lucide-react.mjs";
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-2", children: [
            ...
            itens.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:grid grid-cols-[1fr_90px_110px_120px_40px_40px] gap-2 text-xs uppercase tracking-wide text-muted-foreground px-1", children: [
            ...
            itens.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 p-3 border rounded-lg md:grid md:grid-cols-[1fr_90px_110px_120px_40px_40px] md:gap-2 md:items-center md:p-0 md:border-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] uppercase text-muted-foreground md:hidden mb-1 block", children: "Produto" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: i.produto, onValueChange: (v) => aplicarProdutoCadastrado(i.id, v), children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                    produtosCadastrados.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: p.nome, children: [
                      p.nome,
                      " (",
                      cap(p.unidade),
                      ")"
                    ] }, p.id)),
                    i.produto && !produtosCadastrados.some((p) => p.nome === i.produto) && /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: i.produto, children: i.produto })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", step: "0.01", min: "0", placeholder: "Qtd", value: i.quantidade, onChange: (e) => updItem(i.id, {
                quantidade: Number(e.target.value)
              }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: i.unidade, onValueChange: (v) => updItem(i.id, {
                unidade: v
              }), children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CurrencyInput, { value: i.valor_unitario, onValueChange: (n) => updItem(i.id, {
                valor_unitario: n
              }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", title: "Cadastrar novo produto", onClick: () => abrirNovoProduto(i.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(PackagePlus, { className: "size-4" }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "icon", variant: "ghost", onClick: () => delItem(i.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "size-4" }) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 md:hidden pt-1 border-t border-dashed border-border mt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] uppercase text-muted-foreground", children: "Qtd" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] uppercase text-muted-foreground", children: "Unidade" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] uppercase text-muted-foreground", children: "Valor unit." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CurrencyInput, { value: i.valor_unitario, onValueChange: (n) => updItem(i.id, {
                    valor_unitario: n
                  }) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-end gap-1 pb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "button", variant: "outline", size: "sm", className: "h-9 px-2 text-xs", title: "Cadastrar produto", onClick: () => abrirNovoProduto(i.id), children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(PackagePlus, { className: "size-3.5 mr-1" }),
                    " Novo"
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "destructive", size: "icon", className: "size-9", onClick: () => delItem(i.id), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "size-3.5" }) })
                ] })
              ] })
            ] }, i.id))
          ] })
