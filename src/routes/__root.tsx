  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocorreu um erro no servidor. Você pode tentar atualizar a página ou retornar ao início.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "Gestão Dulce — Doces Lucelian" },
      { name: "description", content: "Painel de gestão da Doces Lucelian — Gestão Dulce" },
      { property: "og:title", content: "Gestão Dulce — Doces Lucelian" },
      { name: "twitter:title", content: "Gestão Dulce — Doces Lucelian" },
      { property: "og:description", content: "Painel de gestão da Doces Lucelian — Gestão Dulce" },
      { name: "twitter:description", content: "Painel de gestão da Doces Lucelian — Gestão Dulce" },
